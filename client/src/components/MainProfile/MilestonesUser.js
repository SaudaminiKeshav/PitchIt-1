    ...
    return <>
        <div className='displayFlex'>
            <div className={classNames( 'userMilestone')}>
                <div className={classNames(props.trips === 1 || props.trips > 1 ? 'displayBlock' : 'displayNone', 'badgeCardStyle')} >
                    <div className={classNames('card', 'badgeCardStyleInner')}>
                        <img src={RookieBadge} alt=" " style={badgeStyle}></img>
                    </div>
                </div>
                <div className={classNames(props.trips === 3 || props.trips > 3 ? 'displayBlock' : 'displayNone', 'badgeCardStyle')}>
                    <div className={classNames('card', 'badgeCardStyleInner')}>
            ...
            <div className={classNames('userMilestone')}>
                <div className={classNames(props.trips === 5 || props.trips > 5 ? 'displayBlock' : 'displayNone', 'badgeCardStyle')}>
                    <div className={classNames('card', 'badgeCardStyleInner')}>
                        <img src={CamperBadge} alt=" " style={badgeStyle}></img>
                    </div>
                </div>

                <div className={classNames(props.trips === 10 || props.trips > 10 ? 'displayBlock' : 'displayNone', 'badgeCardStyle')}>
